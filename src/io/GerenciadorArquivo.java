 ...
 * @version 1.1
 */
public final class GerenciadorArquivo {
	 ...
	 */
	public static boolean renomearArquivo(String nomeArquivo, String novoNome) {
	 ...
	 */
	public static boolean excluirArquivo(String caminho, String nomeArquivo, String extensao) {
	 ...
	 * 
	 * @param caminhoArq
	 *            caminho completo do arquivo + arquivo + extensao
